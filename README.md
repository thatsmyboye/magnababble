...
## How to play
One player creates a game and shares the room code (e.g. KOALA)
Everyone joins with the code and a display name — no account needed
Each round:
...
After all rounds, the player with the most votes wins
...
Word tiles
293 tiles in the default set across five categories — each colour-coded:
...
Add the four environment variables from .env.local in Vercel's project settings
Set NEXT_PUBLIC_APP_URL to your Vercel deployment URL (e.g. https://magnababble.vercel.app)
Deploy
